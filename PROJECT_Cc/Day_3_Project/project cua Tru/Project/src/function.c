...
typedef struct Class Class; // Định nghĩa kiểu dữ liệu Class

// Khai báo nguyên mẫu các hàm
void studentManagementMenu(void);                                     // Hàm menu quản lý sinh viên
void sortStudentListMenu();                                           // Hàm menu sắp xếp danh sách sinh viên
...
bool isValidEmail(char email[]);                                      // Hàm kiểm tra cú pháp email hợp lệ
bool isValidPhoneNumber(char phoneNumber[]);                          // Hàm kiểm tra cú pháp số điện thoại hợp lệ
bool isValidName(char name[]);                                        // Hàm kiểm tra tên hợp lệ (không chứa số hoặc ký tự đặc biệt)
int isValidStudentInfo(char *emailToCheck, char *phoneNumberToCheck); // Hàm kiểm tra trùng lặp dữ liệu sinh viên
void showStudentList();                                               // Hàm hiển thị danh sách sinh viên
void addNewStudent();                                                 // Hàm thêm mới sinh viên
void editStudentInfo();                                               // Hàm chỉnh sửa thông tin sinh viên
void deleteStudent(void);                                             // Hàm xóa sinh viên
void searchStudent();                                                 // Hàm tìm kiếm sinh viên
